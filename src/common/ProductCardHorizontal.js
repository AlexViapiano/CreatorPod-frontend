          ...
          <div className={classes.rightContentContainer}>
            <Link href="/products/[url]" as={`/products/${item.url}`}>
              <a>
                ...
                />
                {/* <div className={classes.bottomContainerDetails_1}>
                  <div className={classes.dietsContainer}>
                    {displayedDiets.map((diet, index) => {
                      return (
                        <div key={diet.id} className={classes.dietImage}>
                          <Image src={diet.src_small} alt={diet?.title} width={30} height={30} />
                        </div>
                      )
                    })}
                  </div>
                  {item?.units > 0 && <div className={classes.unitPack}>{item?.units} PACK</div>}
                </div> */}
