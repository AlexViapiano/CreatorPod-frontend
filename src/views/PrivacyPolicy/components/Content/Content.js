      ...
      <div className={classes.section}>
        <Typography component="p" variant="h5" color="textPrimary" align="left">
          ...
          <p>
            ...
            <a href="Privacy Policy Generator" target="_blank">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                CreatorPod Inc., 551 Rue De La Montagne, QC, H3C 6S4.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to CreatorPod, accessible from{' '}
                <a href="CreatorPod" rel="external nofollow noopener" target="blank">
                  CreatorPod
                </a>
              </p>
            </li>
          ...
          <ul>
            ...
            <li>
              ...
              settings as those used for Browser Cookies. For more information on how You can delete
              Flash Cookies, please read &quot;Where can I change the settings for disabling, or
              deleting local shared objects?&quot; available at{' '}
              <a
                href="Adobe Flash Player End of Life"
          ...
          <ul>
            <li>By email: hello@creatorpod.app</li>
          </ul>
        </Typography>
      </div>
    </div>
