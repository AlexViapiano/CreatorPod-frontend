  ...
  return (
    <div className={classes.root}>
      <div className={classes.container}>
        <Image src="/images/photos/wbox.png" alt="wtg" width={125} height={125} loading="lazy" />
        <Typography color="textPrimary" variant="subtitle1" align="center">
          {t('hero-1')}
        </Typography>
        <Typography color="textPrimary" variant="h2" align="center" className={classes.title}>
          {t('hero-2')}
        </Typography>
...
export default connect(mapStateToProps, mapDispatchToProps)(HeroTrial)
