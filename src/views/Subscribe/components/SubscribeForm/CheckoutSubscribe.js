...
import { createSubscribeSession } from '../../../../../redux/orders/action'
...
const Checkout = props => {
  ...
  const onClickNext = async view => {
    ...
    createSubscribeSession(user.id, metadata)

    const session = await createCheckoutSession(user.id, price, metadata, quantity)
...
const mapDispatchToProps = dispatch => ({
  createCheckoutSession: (userId, subscriptionPrice, metadata, quantity) => {
    return dispatch(createCheckoutSession(userId, subscriptionPrice, metadata, quantity))
  },
  createSubscribeSession: (userId, metadata) => {
    return dispatch(createSubscribeSession(userId, metadata))
  },
})
