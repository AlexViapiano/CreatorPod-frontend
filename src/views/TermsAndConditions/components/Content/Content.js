      ...
      <div className={classes.section}>
        <Typography component="p" variant="h5" color="textPrimary" align="left">
          ...
          **Arbitration, including threshold questions of arbitrability of the dispute, will be
          ...
          <br></br>
          <br></br>
          {t('terms-and-conditions-4')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-5')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-6')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-7')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-8')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-9')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-10')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-11')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-12')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-13')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-14')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-15')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-16')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-17')}
          <br></br>
          <br></br>
          {t('terms-and-conditions-18')} */}
        </Typography>
      </div>
    </div>
  )
