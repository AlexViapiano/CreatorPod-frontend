...
const Checkout = props => {
  ...
  const handleNextAddress = async () => {
    ...
    updateCheckoutSession(checkoutSessionId, { user })
  ...
  const placeOrder = async () => {
    ...
    createOrder(data).then(res => {
      ...
      updateCheckoutSession(checkoutSessionId, { complete: true, order: res.id }, true)
...
const mapDispatchToProps = dispatch => ({
  ...
  updateCheckoutSession: (checkoutSessionId, data, reset) => {
    return dispatch(updateCheckoutSession(checkoutSessionId, data, reset))
  },
})
