    ...
    <div className={clsx(classes.root, className)} {...rest}>
      <div className={classes.section}>
        <Typography component="p" variant="h5" color="textPrimary" align="left">
          ...
          is a flat 10$ unless the order is over 50$. Also, shipping is free for products that are
          ...
          free shipping. YT, NT, NU, NL and Remote Areas are excluded from our free shipping
          program. We are sorry, we do not provide service to these areas at this moment. Should you
          place an order, we would not be, unfortunately, able to address any issues related to your
          order delivery or product spoilage related to weather conditions (such as freezing of
          liquids in the winter or melting of chocolate in the summer). All orders from excluded
          areas would be placed at customer's risk. Please note that your order may also be
          cancelled if we are unable to ship it.
          <br></br> <br></br>
          ...
          products should be shipped to 6732 Rue Jarry E Saint-Léonard, QC H1P 1W3. WayTooGood.com
